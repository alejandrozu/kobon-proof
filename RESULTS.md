...
`Results.classical_NNN` and `Results.simple_NNN` are the theorem aliases, where `NNN` is the zero-padded line count. `Results.earlier_NNN` verifies the earlier inventory's claimed inequality, even when a stronger existing witness now supplies it.

| n | Saved simple lower bound | Saved classical lower bound | Explicit OEIS lower bound | Classical witness |
|---:|---:|---:|---:|---|
...
| 8 | 14 | 14 | 15 | [coordinates](research/finite-table/classical-008.json) · [Lean](Kobon/Certificates/N008T00014H2a63f4d9.lean) |
...
| 14 | 53 | 53 | 54 | [coordinates](research/finite-table/classical-014.json) · [Lean](Kobon/Certificates/N014T00053H45157b2f.lean) |
...
| 20 | 116 | 116 | 117 | [coordinates](research/finite-table/classical-020.json) · [Lean](Kobon/Certificates/N020T00116Hadc03eed.lean) |
...
| 26 | 203 | 203 | 204 | [coordinates](research/finite-table/classical-026.json) · [Lean](Kobon/Certificates/N026T00203He61b423c.lean) |
...
| 32 | 314 | 314 | 315 | [coordinates](research/finite-table/classical-032.json) · [Lean](Kobon/Certificates/N032T00314H9ab78b00.lean) |
...
| 38 | 449 | 449 | 450 | [coordinates](research/finite-table/classical-038.json) · [Lean](Kobon/Certificates/N038T00449H46ad5a32.lean) |
| 39 | 468 | 469 | not listed | [coordinates](research/finite-table/classical-039.json) · [Lean](Kobon/Certificates/N039T00469Hcf24d7d3.lean) |
| 40 | 494 | 494 | not listed | [coordinates](research/finite-table/classical-040.json) · [Lean](Kobon/Certificates/N040T00494H785374ca.lean) |
...
| 44 | 608 | 608 | not listed | [coordinates](research/finite-table/classical-044.json) · [Lean](Kobon/Certificates/N044T00608Hb5277675.lean) |
...
| 47 | 690 | 690 | not listed | [coordinates](research/finite-table/classical-047.json) · [Lean](Kobon/Certificates/N047T00690Hd8af27fc.lean) |
| 48 | 720 | 720 | not listed | [coordinates](research/finite-table/classical-048.json) · [Lean](Kobon/Certificates/N048T00720H5e9767e7.lean) |
| 49 | 767 | 767 | 767 | [coordinates](research/finite-table/classical-049.json) · [Lean](Kobon/Certificates/N049T00767H957e6f15.lean) |
| 50 | 791 | 791 | 792 | [coordinates](research/finite-table/classical-050.json) · [Lean](Kobon/Certificates/N050T00791H2ea22b55.lean) |
| 51 | 816 | 817 | not listed | [coordinates](research/finite-table/classical-051.json) · [Lean](Kobon/Certificates/N051T00817Hbd215f67.lean) |
| 52 | 850 | 850 | not listed | [coordinates](research/finite-table/classical-052.json) · [Lean](Kobon/Certificates/N052T00850H4b0d823a.lean) |
| 53 | 884 | 884 | not listed | [coordinates](research/finite-table/classical-053.json) · [Lean](Kobon/Certificates/N053T00884H723d7eff.lean) |
| 54 | 918 | 918 | not listed | [coordinates](research/finite-table/classical-054.json) · [Lean](Kobon/Certificates/N054T00918H915abb8e.lean) |
| 55 | 954 | 954 | not listed | [coordinates](research/finite-table/classical-055.json) · [Lean](Kobon/Certificates/N055T00954Hea7675d9.lean) |
| 56 | 990 | 990 | not listed | [coordinates](research/finite-table/classical-056.json) · [Lean](Kobon/Certificates/N056T00990Hde8a415c.lean) |
| 57 | 1045 | 1045 | not listed | [coordinates](research/finite-table/classical-057.json) · [Lean](Kobon/Certificates/N057T01045H9a1d337c.lean) |
| 58 | 1073 | 1073 | not listed | [coordinates](research/finite-table/classical-058.json) · [Lean](Kobon/Certificates/N058T01073Hd988db55.lean) |
| 59 | 1102 | 1102 | not listed | [coordinates](research/finite-table/classical-059.json) · [Lean](Kobon/Certificates/N059T01102Hfd3b4280.lean) |
| 60 | 1140 | 1140 | not listed | [coordinates](research/finite-table/classical-060.json) · [Lean](Kobon/Certificates/N060T01140H16af6d0b.lean) |

## Larger hybrid and additional-line witnesses

These rows are finite lower bounds. The 81/161 odd and 82/162 even hybrid witnesses are simple; the 99/195 additional-line witnesses have multiple intersections. None of these rows alone proves an infinite family or settles priority.

| n | Triangles | Simple | Certificate | Lean theorem |
|---:|---:|:---:|---|---|
| 81 | 2132 | yes | [coordinates](research/kobon-hybrid/certificates/n081.json) | [lower_bound](Kobon/Certificates/N081T02132H7bc6b303.lean) |
| 82 | 2172 | yes | [coordinates](research/kobon-hybrid/certificates/n082.json) | [lower_bound](Kobon/Certificates/N082T02172Hd75c9101.lean) |
| 99 | 3169 | no | [coordinates](research/kobon-own-results/certificates/n099.json) | [lower_bound](Kobon/Certificates/N099T03169H4fef38d8.lean) |
| 161 | 8532 | yes | [coordinates](research/kobon-hybrid/certificates/n161.json) | [lower_bound](Kobon/Certificates/N161T08532H230691d5.lean) |
| 162 | 8612 | yes | [coordinates](research/kobon-hybrid/certificates/n162.json) | [lower_bound](Kobon/Certificates/N162T08612H1512e696.lean) |
| 195 | 12481 | no | [coordinates](research/kobon-own-results/certificates/n195.json) | [lower_bound](Kobon/Certificates/N195T12481Hcd3497db.lean) |

The earlier 28:238, 30:275, and 34:357 results are included, with current explicit coordinates and simple-witness checks. The earlier novelty candidates 39:469, 44:608, 51:817, 99:3169, and 195:12481 remain subject to the [priority audit](research/kobon-own-results/novelty-audit.md). In particular, the simple equality at 44 uses an externally cited upper bound; the Lean theorem here is the lower bound and simplicity.

The [full certificate index](verification/certificate-index.json) includes all distinct saved configurations, weaker checkpoints, their coordinate SHA-256 values, original aliases, and exact theorem names. The [earlier inventory](research/kobon-own-results/inventory.json) preserves what was claimed at each stage.
